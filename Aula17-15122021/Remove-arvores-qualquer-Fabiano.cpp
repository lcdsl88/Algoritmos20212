...
void Remover (No *&T, int x){
	/*Remoção da árvore: Era necessário no pseudocódigo verificar se T é nulo antes das remoções à esquerda e à direita, assim:
	if(T!=NULL){ // esse "se" não existia no pseudocódigo 
    Remover(T->Esq,x);
    Remover(T->Dir,x);
	}*/
    if(T!=NULL){
